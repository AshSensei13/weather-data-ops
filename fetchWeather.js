...
const DATA_DIR = path.join(import.meta.dirname, 'data') //creating full path for data folder
fs.mkdirSync(DATA_DIR, { recursive: true }) //if folder doesnt exist, create it, do nothing if folder exists

//create two files inside folder
