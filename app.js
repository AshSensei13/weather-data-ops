...
//app.js needs to read these files
const DATA_DIR = path.join(import.meta.dirname, 'data')
const WEATHER_FILE = path.join(DATA_DIR, 'weather.json') 
const LOG_FILE = path.join(DATA_DIR, 'weather_log.csv')

app.use(express.static(path.join(import.meta.dirname, 'public'))) //auto serve everything inside public, run static webpage
...
//listen for connections to the port and make sure its stable
app.listen(PORT, () => {
